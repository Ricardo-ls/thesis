...
- `stage2_gpt_briefing.md`: factual handoff note used during documentation preparation
- `multi_seed_stage2_plan.md`: archived seed schedule and folder convention for the Phase A sweep
