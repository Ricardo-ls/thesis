...
4. [Stage 2 GPT briefing](stage2_gpt_briefing.md)
5. [Multi-seed plan](multi_seed_stage2_plan.md)
...
- `stage2_phaseA_multiseed_100epoch_report.md` records the multi-seed `100`-epoch screening result and the current mainline interpretation.
- `stage2_gpt_briefing.md` is a fact-only handoff note for GPT.
- `multi_seed_stage2_plan.md` records the seed and folder convention for the archived phase-A sweep and the seed-labeled snapshot layout.
