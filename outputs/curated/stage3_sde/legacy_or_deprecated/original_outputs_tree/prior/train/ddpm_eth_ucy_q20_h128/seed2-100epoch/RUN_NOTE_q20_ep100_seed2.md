# q20 variant - 100-epoch training snapshot

## Purpose

This file records the 100-epoch training snapshot for the `q20` variant under the unified Stage 2 protocol.
